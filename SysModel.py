...
class SystemModel:
    ...
    ###################################################################################################################
    ###################### Unused Functionality For Cases Of Generating Batch of Observations #########################
    ########################## Non Relevant For Control Problem, Only For Estimation Problem ##########################
    ###################################################################################################################

    ######################
    ### Generate Batch ###
    ######################
    def GenerateBatch(self, args, size, T=1, randomInit=False):
        """
        for T=1, our case of UAV tracking problem, the method has:
        input:
        output:
